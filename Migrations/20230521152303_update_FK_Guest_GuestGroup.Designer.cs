...
namespace AltaProject.Migrations
{
    ...
    [Migration("20230521152303_update_FK_Guest_GuestGroup")]
    partial class update_FK_Guest_GuestGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Guest_GuestGroup", b =>
                {
                    b.Property<int>("GuestGroupsId")
                        .HasColumnType("integer");

                    b.Property<int>("GuestsId")
                        .HasColumnType("integer");

                    b.HasKey("GuestGroupsId", "GuestsId");

                    b.HasIndex("GuestsId");

                    b.ToTable("Guest_GuestGroup");
                });
            ...
            modelBuilder.Entity("Guest_GuestGroup", b =>
                {
                    b.HasOne("AltaProject.Entity.GuestGroup", null)
                        .WithMany()
                        .HasForeignKey("GuestGroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
